...
export default async function NotFound() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-9 h-full my-auto md:gap-11.5">
      ...
      <Link href="/en" className="relative bg-theme-1 rounded-lg px-14.5 py-2.5 md:pl-15 md:rounded-xl md:pr-20 md:py-3 cursor-pointer flex">
        <span className="text-white font-medium text-xs tracking-[0px] md:font-bold md:text-base md:leading-[1.32] md:tracking-[.5px]">Back to Home</span>
