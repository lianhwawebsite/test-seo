      ...
      <div className="mx-auto max-w-[1200px] grid grid-cols-1 gap-15 font-notoSansTC md:grid-cols-2 md:gap-30 lg:gap-52">
        ...
        <div className="flex flex-col justify-center items-center gap-5 md:items-start md:gap-7">
          <div className="flex flex-col justify-center items-center gap-1.5 md:items-start md:gap-1">
            <h2 className="text-center w-fit font-medium text-lg leading-[1.21] tracking-[0.3px] md:text-left md:font-bold md:text-lg md:leading-[1.24] md:tracking-[0.6px]">{companyTitle}</h2>
            <p className="text-center font-medium text-base leading-[1.21] tracking-[0.3px] md:text-left md:text-sm md:leading-[1.24] md:tracking-[0.3px]">{companyEnglishTitle}</p>
          </div>
