...
export default function Footer() {
  ...
  return (
    <footer className="absolute z-10 bottom-0 row-start-3 w-full ">
        <NextBreadcrumb />
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 py-12 px-16  w-full bg-stone-700 text-stone-100 gap-4">
          <div className="flex items-center md:col-span-1 lg:col-span-1 justify-center md:justify-start">
            <Link href={homeItem?.href || ""} className="w-fit py-6 px-24 bg-stone-400 text-stone-500">
              {homeItem?.label}
            </Link>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center md:items-end md:col-span-2 lg:col-span-1">
            <div className="flex flex-col md:flex-row justify-center items-center md:justify-between md:items-start text-base md:text-md lg:text-lg w-full md:gap-4">
