...
export const ServiceSecond = ({ data }: { data: Service }) => {
  return (
    <div className="w-full bg-customGray md:bg-customGray-6">
      <div className="w-full flex flex-col md:grid mx-auto max-w-[1440px] gap-8 lg:gap-20 md:grid-rows-1 md:grid-cols-6 py-12 px-6 lg:py-16 lg:px-52">
        ...
        <div className="md:col-span-3 text-sm text-start leading-[1.28] md:text-[15px] md:leading-[1.6] tracking-[0.4px] flex items-center lg:center">{data.description}</div>
      </div>
    </div>
  );
};
