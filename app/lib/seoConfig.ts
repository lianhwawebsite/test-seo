...
export const seoMeta: Record<string, Record<string, MetaInfo>> = {
  ...
  en: {
    home: {
      title: "Test Studio | Creative Web & Brand Design",
      description: "Test Studio focuses on creating websites with both design and function.",
      schema: {
        "@context": "https://schema.org",
        "@type": "Organization",
        name: "Test Studio",
    ...
    about: {
      ...
      description: "Test Studio is a creative team focused on brand design and website development.",
      schema: {
        "@context": "https://schema.org",
        "@type": "WebSite",
        name: "Test Studio",
    ...
    products: {
      title: "Products｜Test Studio",
      description: "Products, Test Studio's all products.",
      schema: {
        "@context": "https://schema.org",
        "@type": "WebSite",
        name: "Test Studio",
    ...
    contact: {
      title: "Contact｜Test Studio",
      description: "Test Studio is here to help you create your ideal brand.",
      schema: {
        "@context": "https://schema.org",
        "@type": "WebSite",
        name: "Test Studio",
